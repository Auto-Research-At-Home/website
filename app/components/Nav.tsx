  ...
  return (
    <header className="border-b border-[var(--color-line)]">
      <div className="container-page flex h-16 items-center justify-between">
        <Link
          href="/"
          className="flex items-center gap-2.5 font-mono text-[14px] tracking-tight"
        >
          <Image
            src="/logos/icon.jpeg"
            alt="OpenResearch"
            width={32}
            height={32}
            className="h-8 w-8 rounded-full ring-1 ring-[var(--color-line)]"
            priority
          />
          <span className="text-[var(--color-fg-muted)]">/</span>
          <span className="text-[var(--color-fg)]">OpenResearch</span>
        </Link>
